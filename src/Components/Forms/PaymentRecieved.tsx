...
export interface PaymentsReceivedFormValues {
    dateTime: string;
    partyName: string;
...
const PaymentsReceivedForm: React.FC<FormikProps<PaymentsReceivedFormValues>> = ({ values, setFieldValue, handleSubmit }) => {
